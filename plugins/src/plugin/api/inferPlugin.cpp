...
extern "C"
{
    bool initLibNvInferPlugins(void* logger, char const* libNamespace)
    {
        ...
        // initializePlugin<nvinfer1::plugin::TransformerEncodePluginDynamicCreator>(logger, libNamespace);
        // initializePlugin<nvinfer1::plugin::TransformerDecodePluginDynamicCreator>(logger, libNamespace);
